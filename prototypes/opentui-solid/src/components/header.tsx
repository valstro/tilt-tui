...
export function Header() {
  ...
  const connectionIcon = createMemo(() => connectionStatusIcon(state.connectionStatus))
  const connectionColor = createMemo(() => connectionStatusColor(theme, state.connectionStatus))
  const connectionText = createMemo(() => connectionStatusText(state.connectionStatus))
